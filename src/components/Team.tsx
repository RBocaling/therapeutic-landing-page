import { Linkedin, Mail, Award, BookOpen, Facebook } from "lucide-react";
  ...
  const teamMembers = [
    {
      ...
      image: teamImage,
      bio: "Passionate educator and researcher developing innovative solutions for educational institutions and the community. This platform represents a comprehensive graduate thesis project focused on integrating AI-guided therapeutic care into modern educational frameworks.",
      credentials: [
        "Master of Science in Information Technology (Candidate)",
        "ASCOT Instructor from 2017 – present",
        "Former IT Coordinator 1 of the Philippine Survey and Research Center",
        "Dance Fitness Coach – for physical wellbeing",
        "Mental Health Advocacy Specialist",
      ],
      email: "https://kingalvin.grospe@ascot.edu.ph",
      linkedin: "https://www.facebook.com/kingalvin.grospe",
    },
  ];
  ...
  const achievements = [
    {
      ...
      description:
        "Recognized for innovative approaches in mental health education and student wellbeing programs",
    },
    {
      icon: BookOpen,
      title: "Community Impact",
      description:
        "Developed comprehensive mental health curriculum and resources adopted by multiple educational institutions",
    },
  ];
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16 animate-in fade-in slide-in-from-top duration-700">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Led by an experienced professional dedicated to advancing mental
