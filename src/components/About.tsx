      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12 animate-in fade-in slide-in-from-top duration-700">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Bridging traditional therapeutic excellence with modern technology
            to deliver accessible, effective mental health care for everyone.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-7">
          ...
          <div className="space-y-6 animate-in fade-in duration-700">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              Founded on the belief that quality mental health care should be
              accessible to all, Therapeutic combines the wisdom of experienced
              professionals and the power of artificial intelligence. The
              platform offers a comprehensive suite of services designed to
              support your mental wellness journey.
            </p>
            <p className="text-lg text-muted-foreground leading-relaxed">
              From initial assessments and AI-guided Therapeutic Lifestyle
              Changes to direct counselor communication and structured courses,
              the platform provides multiple pathways to better mental health.
