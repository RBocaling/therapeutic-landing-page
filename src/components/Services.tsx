      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-9 animate-in fade-in slide-in-from-top duration-700">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            A complete suite of tools and services designed to support every
            aspect of your mental wellness journey
          </p>
        </div>
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-primary/80 to-transparent flex items-end p-8">
              <div className="text-primary-foreground">
                ...
                <p className="text-primary-foreground/90">
                  Intelligent assistance available anytime, anywhere
                </p>
              </div>
            </div>
          </div>
          <div
            className="relative rounded-3xl overflow-hidden border border-border/50 group animate-in fade-in slide-in-from-right duration-700 delay-200"
            style={{ boxShadow: "var(--shadow-strong)" }}
          >
            <img
              src={wellnessImage}
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-primary-glow/80 to-transparent flex items-end p-8">
              <div className="text-primary-foreground">
                ...
                <p className="text-primary-foreground/90">
                  Personalized exercises for mind and body
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service, index) => (
            ...
            >
              <div
                className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${service.color} flex items-center justify-center mb-4 group-hover:scale-110 group-hover:rotate-3 transition-all duration-500`}
        ...
        <div className="mt-7 text-center bg-gradient-to-r from-primary-light/30 to-primary-light/10 rounded-3xl p-12 border border-primary/20 animate-in fade-in slide-in-from-bottom duration-700 delay-500">
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            Join us and transform your mental health with our comprehensive
            platform
          </p>
          <button
            onClick={() =>
