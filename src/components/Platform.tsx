...
const Platform = () => {
  return (
    <section className="py-24 bg-gradient-to-b from-background to-primary-light/10 overflow-hidden" style={{ boxShadow: 'inset 0 1px 0 0 hsl(var(--border)/0.3)' }}>
      <div className="container mx-auto px-4">
        <div className="text-center mb-16 animate-in fade-in slide-in-from-top duration-700">
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-4">
            Experience Our <span className="bg-gradient-to-r from-primary to-primary-glow bg-clip-text text-transparent">Platform</span>
          </h2>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            A seamless mental health experience across all your devices - beautifully designed, intuitively crafted
          </p>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="relative animate-in fade-in duration-700">
              ...
              <div className="mt-6 text-center">
                <h3 className="text-2xl font-bold text-foreground mb-2">Desktop Experience</h3>
                <p className="text-muted-foreground">Full-featured platform with seamless authentication and comprehensive tools</p>
              </div>
            </div>
            ...
            <div className="relative animate-in fade-in duration-700">
              ...
              <div className="relative h-[500px] flex items-center justify-center max-w-sm mx-auto">
                <img
                  src={platformMobile}
              ...
              <div className="mt-6 text-center">
                <h3 className="text-2xl font-bold text-foreground mb-2">Mobile Dashboard</h3>
                <p className="text-muted-foreground">Track your progress, book sessions, and access support on the go</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-20">
            {[
              ...
              },
              {
                ...
                description: "Track your mental health journey with live progress monitoring"
              },
              {
