          ...
          <div className="hidden md:block">
            <Dialog open={isGetStartedOpen} onOpenChange={setIsGetStartedOpen}>
              <DialogTrigger asChild>
                <Button className="rounded-full bg-white hover:shadow-lg transition-all duration-300 hover:scale-105">
                  Get Started
                </Button>
              </DialogTrigger>
              <DialogContent
                ...
                <div className="relative p-8">
                  ...
                  <div className="flex flex-col gap-3 mt-8">
                    <Button
                      ...
                      className="h-14 rounded-2xl bg-white hover:shadow-2xl transition-all duration-300 hover:scale-[1.02] text-base font-semibold relative overflow-hidden group"
                      style={{
          ...
          <div className="md:hidden py-4 border-t border-border animate-in fade-in slide-in-from-top-2 bg-white  relative z-[99999] h-[90vh]">
            <nav className="flex flex-col space-y-2">
              ...
              >
                ...
                <DialogContent
                  className="max-w-md border-0 bg-background/95 backdrop-blur-2xl p-0 overflow-hidden mx-4 relative "
                  style={{
                    boxShadow:
                      "0 25px 50px -12px hsl(var(--primary)/0.25), 0 0 0 1px hsl(var(--primary)/0.1), inset 0 1px 2px 0 hsl(var(--foreground)/0.05)",
                  }}
                >
                  ...
                  <div className="relative p-6 sm:p-8  rounded-3xl z-[9999]">
                    <DialogHeader className="space-y-3">
                      <div
                        className="mx-auto w-14 h-14 sm:w-16 sm:h-16 rounded-3xl bg-gradient-to-br from-primary to-primary-glow flex items-center justify-center mb-2"
                        style={{
                          boxShadow: "0 10px 30px -5px hsl(var(--primary)/0.5)",
                        }}
                      >
