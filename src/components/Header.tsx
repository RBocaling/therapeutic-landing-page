          ...
          <div className="hidden md:block">
            <Dialog open={isGetStartedOpen} onOpenChange={setIsGetStartedOpen}>
              <DialogTrigger asChild>
                <Button className="rounded-full h-12 bg-primary hover:shadow-lg transition-all duration-300 hover:scale-105">
                  Get Started
                </Button>
              </DialogTrigger>
              <DialogContent
                className="sm:max-w-md border-0 rounded-3xl bg-background/95 backdrop-blur-2xl p-0 overflow-hidden"
                style={{
                  boxShadow:
                    "0 25px 50px -12px hsl(var(--primary)/0.25), 0 0 0 1px hsl(var(--primary)/0.1), inset 0 1px 2px 0 hsl(var(--foreground)/0.05)",
                }}
              >
                {/* Gradient overlay */}
                ...
                <div className="relative p-8">
                  <DialogHeader className="space-y-4">
                    <div
                      className="mx-auto w-16 rounded-3xl bg-gradient-to-br from-primary to-primary-glow flex items-center justify-center mb-2"
                      style={{
                        boxShadow: "0 10px 30px -5px hsl(var(--primary)/0.5)",
                      }}
                    >
                  ...
                  <div className="flex flex-col gap-3 mt-8">
                    ...
                    <Button
                      ...
                      style={{
                        boxShadow:
                          "0 4px 15px -3px hsl(var(--primary)/0.1), inset 0 1px 1px 0 hsl(var(--foreground)/0.05)",
                      }}
                    >
          ...
          <div className="md:hidden py-4 border-t border-border animate-in fade-in slide-in-from-top-2 bg-white  relative z-[99999] h-[90vh]">
            <nav className="flex flex-col space-y-2">
              ...
              <div className=" md:hidden">
                ...
                >
                  <DialogTrigger asChild>
                    <Button className="rounded-full  h-14 w-full bg-primary hover:shadow-lg transition-all duration-300 hover:scale-105">
                      Get Started
                    </Button>
                  </DialogTrigger>
                  <DialogContent
                    className="sm:max-w-md border-0 bg-background/95 backdrop-blur-2xl p-0 rounded-3xl overflow-hidden"
                    style={{
                      boxShadow:
                        "0 25px 50px -12px hsl(var(--primary)/0.25), 0 0 0 1px hsl(var(--primary)/0.1), inset 0 1px 2px 0 hsl(var(--foreground)/0.05)",
                    }}
                  >
                    ...
                    <div className="relative p-8">
                      <DialogHeader className="space-y-4">
                        <div
                          className="mx-auto w-16 h-16 rounded-3xl bg-gradient-to-br from-primary to-primary-glow flex items-center justify-center mb-2"
                          style={{
                            boxShadow:
                        ...
                        <DialogDescription className="text-center text-muted-foreground">
                          Choose how you'd like to access ASCOT Mental Health
                          Care
                        </DialogDescription>
                      </DialogHeader>
